...
# Configuration
CSV_FILE = Path(__file__).parent.parent.parent / "CRMServiceRequests_1548651211056691263.csv"
LAST_N_DAYS = 30
...
def load_data():
    ...
    df = pd.read_csv(CSV_FILE, parse_dates=['Date Created', 'Date Closed', 'Date Last Updated'])
